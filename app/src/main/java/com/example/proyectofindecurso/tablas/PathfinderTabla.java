...
public class PathfinderTabla {
    ...
    public PathfinderTabla(Integer id, Integer nivel, String raza, String clase, String nombre, String alineamiento, String transfondo, Integer fuerza, Integer destreza, Integer constitucion, Integer inteligencia, Integer sabiduria, Integer carisma) {
        this.id = id;
        this.nivel = nivel;
        this.raza = raza;
        this.clase = clase;
